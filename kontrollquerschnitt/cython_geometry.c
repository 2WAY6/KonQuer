 ...
 */
  __pyx_t_8 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_double); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_7 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)2)); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 26, __pyx_L1_error)
  ...
  __pyx_t_9 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(((PyObject *)__pyx_t_6), PyBUF_WRITABLE); if (unlikely(!__pyx_t_9.memview)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_DECREF(((PyObject *)__pyx_t_6)); __pyx_t_6 = 0;
  __pyx_t_7 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_double); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_8 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)2)); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
...
static PyObject *__pyx_pw_15cython_geometry_1segments_intersect(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("segments_intersect (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_B)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("segments_intersect", 1, 4, 4, 1); __PYX_ERR(0, 34, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_C)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("segments_intersect", 1, 4, 4, 2); __PYX_ERR(0, 34, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_D)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("segments_intersect", 1, 4, 4, 3); __PYX_ERR(0, 34, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "segments_intersect") < 0)) __PYX_ERR(0, 34, __pyx_L3_error)
      }
    ...
    __pyx_v_D = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_D.memview)) __PYX_ERR(0, 34, __pyx_L3_error)
  }
...
static PyObject *__pyx_pf_15cython_geometry_segments_intersect(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_B, __Pyx_memviewslice __pyx_v_C, __Pyx_memviewslice __pyx_v_D) {
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("segments_intersect", 0);
  __Pyx_TraceCall("segments_intersect (wrapper)", __pyx_f[0], 34, 0, __PYX_ERR(0, 34, __pyx_L1_error));
...
static int __pyx_f_15cython_geometry_is_point_in_polygon(__Pyx_memviewslice __pyx_v_P, __Pyx_memviewslice __pyx_v_R, __Pyx_memviewslice __pyx_v_polygon, struct __pyx_opt_args_15cython_geometry_is_point_in_polygon *__pyx_optional_args) {
  ...
  __Pyx_TraceCall("is_point_in_polygon", __pyx_f[0], 59, 0, __PYX_ERR(0, 59, __pyx_L1_error));
...
static PyObject *__pyx_pw_15cython_geometry_3assign_points_to_polygons(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("assign_points_to_polygons (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_polygons)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("assign_points_to_polygons", 1, 4, 4, 1); __PYX_ERR(0, 78, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_points_conn_polygons)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("assign_points_to_polygons", 1, 4, 4, 2); __PYX_ERR(0, 78, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_polygon_bboxes)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("assign_points_to_polygons", 1, 4, 4, 3); __PYX_ERR(0, 78, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "assign_points_to_polygons") < 0)) __PYX_ERR(0, 78, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 4) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_points = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_points.memview)) __PYX_ERR(0, 78, __pyx_L3_error)
    __pyx_v_polygons = ((PyObject*)values[1]);
    __pyx_v_points_conn_polygons = __Pyx_PyObject_to_MemoryviewSlice_ds_long(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_points_conn_polygons.memview)) __PYX_ERR(0, 78, __pyx_L3_error)
    __pyx_v_polygon_bboxes = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_polygon_bboxes.memview)) __PYX_ERR(0, 78, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
...
static PyObject *__pyx_pf_15cython_geometry_2assign_points_to_polygons(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_points, PyObject *__pyx_v_polygons, __Pyx_memviewslice __pyx_v_points_conn_polygons, __Pyx_memviewslice __pyx_v_polygon_bboxes) {
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("assign_points_to_polygons", 0);
  __Pyx_TraceCall("assign_points_to_polygons (wrapper)", __pyx_f[0], 78, 0, __PYX_ERR(0, 78, __pyx_L1_error));
  __Pyx_XDECREF(__pyx_r);
...
static int __pyx_f_15cython_geometry_assign_point_to_polygon(__Pyx_memviewslice __pyx_v_P, PyObject *__pyx_v_polygons, int __pyx_v_n_polys, __Pyx_memviewslice __pyx_v_polygon_bboxes, struct __pyx_opt_args_15cython_geometry_assign_point_to_polygon *__pyx_optional_args) {
  ...
  __Pyx_TraceCall("assign_point_to_polygon", __pyx_f[0], 91, 0, __PYX_ERR(0, 91, __pyx_L1_error));
  if (__pyx_optional_args) {
 ...
 */
  ...
  __pyx_t_4 = 0;
  __pyx_t_2 = PyFloat_FromDouble(((*((double *) ( /* dim=0 */ (__pyx_v_P.data + __pyx_t_4 * __pyx_v_P.strides[0]) ))) + __pyx_v_ray_length)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 93, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = 1;
  __pyx_t_5 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_P.data + __pyx_t_4 * __pyx_v_P.strides[0]) )))); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 93, __pyx_L1_error)
  ...
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 93, __pyx_L1_error)
